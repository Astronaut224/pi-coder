...
Pi Web はクロスプラットフォームの Electron デスクトップアプリとしても提供されます。Web UI のすべての機能に加え、ネイティブならではの便利機能を備えています：

- **システムトレイ**：トレイアイコンをクリックしてウィンドウを切り替え。ウィンドウを閉じても Pi Web はトレイに常駐します。
