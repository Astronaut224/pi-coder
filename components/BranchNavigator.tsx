      ...
      >
        ...
        {role && (
          <span style={{
            ...
            background: role === "user" ? "color-mix(in srgb, var(--accent) 9%, transparent)" : "var(--bg-hover)",
            border: `1px solid ${role === "user" ? "color-mix(in srgb, var(--accent) 22%, transparent)" : "var(--border)"}`,
            borderRadius: 3,
            padding: "0 4px",
            marginRight: 5,
            flexShrink: 0,
