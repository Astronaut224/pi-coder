  ...
  return (
    ...
    >
      {isDragOver && !sessionBusy && (
        <div className="pointer-events-none absolute inset-0 z-50 flex animate-[drop-zone-in_0.15s_ease_both] items-center justify-center bg-[rgba(242,140,40,0.06)] backdrop-blur-[1px]">
          <div className="pointer-events-none absolute inset-0 flex items-center justify-center">
            {[0, 0.8, 1.6].map((delay) => (
              <div
                key={delay}
                className="absolute h-[720px] w-[720px] rounded-full border-[1.5px] border-solid border-[rgba(242,140,40,0.5)] animate-[drop-ripple_2.4s_ease-out_infinite_backwards]"
          ...
          <svg
            ...
            className="drop-shadow-[0_6px_18px_rgba(242,140,40,0.18)]"
          >
            <rect x="28" y="44" width="84" height="60" rx="8" fill="rgba(242,140,40,0.08)" stroke="rgba(242,140,40,0.50)" strokeWidth="1.8"/>
            <path d="M36 100 L54 72 L68 88 L80 74 L104 100Z" fill="rgba(242,140,40,0.16)" stroke="rgba(242,140,40,0.40)" strokeWidth="1.4" strokeLinejoin="round"/>
            <circle cx="96" cy="58" r="8" fill="rgba(242,140,40,0.22)" stroke="rgba(242,140,40,0.55)" strokeWidth="1.6"/>
            <g stroke="rgba(242,140,40,0.45)" strokeWidth="1.4" strokeLinecap="round">
          ...
          <div className="w-full max-w-[820px]">
            ...
            >
              <div style={{ display: "flex", alignItems: "baseline", gap: isMobile ? 7 : 10, minWidth: 0, flex: 1, lineHeight: 1.4, overflow: "hidden" }}>
                ...
                <span style={{ fontSize: 22, color: "var(--text)", fontWeight: 700, letterSpacing: 0, flexShrink: 0, whiteSpace: "nowrap" }}>Pi Coder</span>
                <NewSessionUpdateLink label={(version) => t("appUpdate.releaseNotes", { version })} />
              </div>
              <div style={{ display: "flex", flexDirection: "column", alignItems: "flex-end", gap: 2, flexShrink: 0 }}>
                <span style={{ fontSize: 11, color: "var(--text-muted)" }}>
                  coder <span style={{ color: "var(--text)" }}>v{process.env.NEXT_PUBLIC_APP_VERSION ?? "0.0.0"}</span>
                </span>
                <span style={{ fontSize: 11, color: "var(--text-muted)" }}>
