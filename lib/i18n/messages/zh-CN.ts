...
export const zhCNLocale: LocalePlugin = {
  ...
  messages: {
    ...
    "theme.darkOnly": "仅暗色",
    "theme.lightOnly": "仅亮色",
    "theme.bothVariants": "亮色 / 暗色",
    "theme.loadFailed": "加载主题失败",
    "theme.noCustomThemes": "未找到自定义主题",
    "theme.reload": "重新加载主题",
    "theme.applying": "应用中…",
    "history.full": "完整历史",
    ...
    "sideChat.button": "聊天",
    "sideChat.subtitle": "不影响当前主进程，要顺便聊点别的吗？",
    "sideChat.tab": "聊天",
    "sideChat.open": "打开侧边聊天",
    "sideChat.readOnly": "只读",
    "sideChat.edit": "编辑",
    "sideChat.refork": "重新 Fork",
    "sideChat.clear": "清空",
    "sideChat.stop": "停止",
    ...
    "sideChat.expired": "此副聊天因长时间未操作已被清理。点击「重新 Fork」可从主会话重新拉取一份。",
    ...
    "sidebar.timeGroup.last7": "最近7天",
    "sidebar.timeGroup.last30": "最近30天",
    "sidebar.timeGroup.earlier": "更早",
    "sidebar.status.title": "状态",
    "sidebar.status.none": "无标记",
    "sidebar.status.completed": "完成",
    "sidebar.status.pending": "待定",
    "sidebar.status.discussing": "讨论中",
    ...
    "chat.expandComposer": "展开编辑框",
    "chat.collapseComposer": "收起编辑框",
    "chat.resizeComposer": "拖动调整编辑框高度",
    ...
    "update.retry": "重试",
    "update.confirmPrompt": "是否立即下载并安装？",
    "update.confirmUpdate": "确认更新",
    "update.cancel": "取消",
