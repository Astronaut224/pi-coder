...
export const enLocale: LocalePlugin = {
  ...
  messages: {
    ...
    "theme.lightOnly": "Light only",
    "theme.bothVariants": "Light / Dark",
    "theme.loadFailed": "Failed to load themes",
    "theme.noCustomThemes": "No custom themes found",
    ...
    "sideChat.button": "Chat",
    "sideChat.subtitle": "Won't affect the main session. Want to chat about something else?",
    "sideChat.tab": "Chat",
    "sideChat.open": "Open side chat",
    "sideChat.readOnly": "Read-only",
    "sideChat.edit": "Edit",
    "sideChat.refork": "Re-fork",
    ...
    "sideChat.expired": "This side chat expired after inactivity and was cleared. Re-fork pulls a fresh copy from the main session.",
    ...
    "sidebar.timeGroup.last7": "Last 7 days",
    "sidebar.timeGroup.last30": "Last 30 days",
    "sidebar.timeGroup.earlier": "Earlier",
    "sidebar.status.title": "Status",
    "sidebar.status.none": "No mark",
    "sidebar.status.completed": "Done",
    "sidebar.status.pending": "Pending",
    "sidebar.status.discussing": "Discussing",
    ...
    "chat.resizeComposer": "Drag to resize composer",
    ...
    "update.retry": "Retry",
    "update.confirmPrompt": "Download and install now?",
    "update.confirmUpdate": "Confirm update",
